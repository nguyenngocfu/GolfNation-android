 ...
 */
public class ManagedGameAdapter extends BaseAdapter {
    private Context context;
    private List<Game> games = new ArrayList<Game>();
    public ManagedGameAdapter(Context ctx) {
        context = ctx;
    }
    ...
    public View getView(final int i, View view, ViewGroup viewGroup) {
        ...
        if(view == null) {
            ...
            view = inflater.inflate(R.layout.lv_managedgame_element, null, false);
            viewHoder.btnManage = (Button) view.findViewById(R.id.btn_manage);
        ...
        viewHoder.btnManage.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Fragment manageGameFragment = ManageGameFragment.newInstance(games.get(i).getId(),games.get(i).getCost());
